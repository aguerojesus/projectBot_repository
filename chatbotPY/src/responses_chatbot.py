...
def get_respuesta(key):
    return respuestas.get(key, "Respuesta no encontrada.")

# Método de búsqueda por nombres
contacts = [
    {"first_name": "Juan", "last_name": "Pérez", "phone": "12345678", "email": "juanperez@ucr.ac.cr"},
    {"first_name": "María", "last_name": "Gómez", "phone": "87654321", "email": "mariagomez@ucr.ac.cr"},
    {"first_name": "Carlos", "last_name": "Sánchez", "phone": "11223344", "email": "carlossanchez@ucr.ac.cr"},
    {"first_name": "Ana", "last_name": "López", "phone": "99887766", "email": "analopes@ucr.ac.cr"},
]
...
def search_contact(name):
    ...
    # Busca los contactos que coincidan con el nombre completo o parcial
    if len(name_parts) == 1:  # Solo el primer nombre
        return [contact for contact in contacts if contact['first_name'].lower() == name_parts[0].lower()]
    elif len(name_parts) == 2:  # Primer nombre y primer apellido
        return [contact for contact in contacts if contact['first_name'].lower() == name_parts[0].lower() and contact['last_name'].lower() == name_parts[1].lower()]
    else:
        return []

# Ejemplo de búsqueda
print(search_contact("Juan Pérez"))  # Buscar por nombre completo
print(search_contact("Carlos"))  # Buscar solo por el primer nombre
