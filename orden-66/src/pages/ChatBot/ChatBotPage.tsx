        ...
        <div className="chatbot">
            ...
            <div className="floatButtons">
                {button.map((button, index) => (
                    <div className="buttonContainer" style={{marginTop: index * 40 + "px"}}>
                        <FloatButton key={index} text={button.text} iconPath={button.iconPath} onClick={button.onClick} />
